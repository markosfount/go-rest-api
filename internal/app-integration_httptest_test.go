...
func (s *AppSuite) TestCreateNonExistingMovie() {
	// Create movie
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()

	urlRegex := regexp.MustCompile("https://api.themoviedb.org/3/search/movie*")
	httpmock.RegisterRegexpResponder("GET", urlRegex,
		func(r *http.Request) (*http.Response, error) {
			res, err := httpmock.NewJsonResponse(200, "{\n  \"results\": [\n    {\n      \"id\": 1,\n      \"original_title\": \"name1\",\n      \"overview\": \"foobar.\",\n      \"runtime\": 142\n    }], \"total_results\": 2}")
			return res, err
		},
	)
